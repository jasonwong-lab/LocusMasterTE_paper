...
## Load the Datasets ##
short_read <- read.delim("https://figshare.com/ndownloader/files/39037994", comment.char="#")
...
short_read$TPM <- (tpm3(as.numeric(short_read$X.storage2.jwlab.sandy.HCT116.SQUIRE.squire_map.library1.concat_file_Library1_B.fastq.bam), as.numeric(short_read$Length)))/library_size_short
...
short_read_fc_coding_gene_cleanup$TPM <- (tpm3(as.numeric(short_read_fc_coding_gene_cleanup$X.storage.jwlab.sandy.HCT116.SQUIRE.squire_map.library1.concat_file_Library1_B.fastq.bam), as.numeric(short_read_fc_coding_gene_cleanup$Length)))/library_size_short
