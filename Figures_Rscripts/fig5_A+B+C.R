...
p_cor_5kb <- p_cor_5kb + My_Theme + xlab("abs(cor.value) by Telescope")+ylab("abs(cor.value) by LocusMasterTE") + ggtitle("Cor.value of intergenic TE +/- 5kb \nwith upstream of coding genes") + theme(legend.position = "none")
...
p_cor_5kb_down <- p_cor_5kb_down + My_Theme + xlab("abs(cor.value) by Telescope")+ylab("abs(cor.value) by LocusMasterTE") + ggtitle("Cor.value of intergenic TE +/- 5kb \nwith downstream of coding genes") + theme(legend.position = "none")
